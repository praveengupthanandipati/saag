...
<body>
    ...
    <main>
        ...
        <!-- get in touch -->
        <section class="getintouch-home">
            <div class="custom-container">
                <div class="row">
                    <div class="col-md-4">
                         <div class="title-section">                           
                            <h2 class="font-bold font-white">Let's Create Something Infinite.</h2>
                             <h5 class="font-white">Whether you're here to learn, build, create, or collaborate.</h5>
                             <a href="javascript:void(0)" class="primary-btn mt-3">Get in Touch Today</a>
                        </div>
                    </div>
                </div>
            </div>
